...
$IF($ARGUMENTS,
  ...
  **slides-list** → `python scripts/run.py artifact_manager.py list --type slide-deck`

  **slides-status <task-id>** → `python scripts/run.py artifact_manager.py status --task-id "<task-id>"`
